...
const plans = [
  {
    ...
    features: ["100,000 API requests per month", "Basic analytics", "24/7 support", "1 team member"],
  },
  {
    name: "Pro",
    price: "$29.99",
  ...
  return (
    <div className=' space-y-6'>
      ...
      <p className="text-muted-foreground">
        Choose the plan that best fits your needs and take your project to the next level.
      </p>
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {plans.map((plan) => (
          <Card key={plan.name} className="flex flex-col">
            ...
            <CardFooter>
              <Button className="w-full bg-gradient-to-b from-cyan-600 to-sky-400">{plan.name === "Enterprise" ? "Contact Sales" : "Upgrade Now"}</Button>
            </CardFooter>
          </Card>
        ))}
      </div>
